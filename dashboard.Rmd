...
### Participant view of living situation predictor against PHQ-2, stratified by race (EM) to show the differences in PHQ-2 (depression risk scale) distribution across categories. Proportion of higher PHQ-2 score were greater among lower satisfaction with living situations. 
...
### Differences in depression outcome by social network (stratified by gender) and perceived overall health:
...
### Differences in depression outcome by self-rated memory. 
...
### Differences in depression outcome by use of cane walker/wheelchair. 
