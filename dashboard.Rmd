...
### Participant view of living situation predictor against PHQ-2, stratified by race (EM) to show the differences in PHQ-2 (depression risk scale) distribution across categories. 

```{r}
<<<<<<< HEAD
=======

>>>>>>> 3b08b0734821196a9dc4482a1f6488f7ed5d5033
living_plot = nhats %>% 
...
### Differences in depression outcome by social network.

Plotting health by phq_cat:
