...
<<<<<<< HEAD
- Survey respondents were asked if they used a cane walker wheelchair. The plot below is a visualization of the proportion of respondents in this dataset by their depression outcome status - Low Depression Risk or Elevated Depression Risk. The figure is stratified by if participants responded Yes, or No (x-axis) using a cane, walker, or wheelchare. There doesn't appear to be a difference in proportion of respondents use or don't use an assistive device among those who had elevated depression risk. Among those who had a low risk of depression scores, we see that there is a higher proportion respondents that do use an assistive device. 
=======
...
>>>>>>> c8c17fe033095c299968cbf5e1e125bfeff00fe3
